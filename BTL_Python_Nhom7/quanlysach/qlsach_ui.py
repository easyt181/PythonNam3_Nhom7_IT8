...
"")
        ...
        self.verticalLayoutWidget.setGeometry(QRect(0, 0, 1201, 49))
        ...
        self.btnThemSach.setGeometry(QRect(10, 60, 170, 50))
        font1 = QFont()
        ...
        self.btnLamMoi.setGeometry(QRect(190, 60, 170, 51))
        ...
        self.layoutWidget.setGeometry(QRect(10, 130, 1191, 53))
        ...
        self.tableSach.setGeometry(QRect(10, 200, 1191, 531))
        qlsach.setCentralWidget(self.centralwidget)
        self.menubar = QMenuBar(qlsach)
        self.menubar.setObjectName(u"menubar")
        self.menubar.setGeometry(QRect(0, 0, 1212, 21))
    ...
    def retranslateUi(self, qlsach):
        ...
        self.btnThemSach.setText(QCoreApplication.translate("qlsach", u"Th\u00eam s\u00e1ch", None))
