...
from baocaothongke.chitiethoadonban_ui import Ui_Dialog
from baocaothongke.chucnangtrahang import ChucNangTraHang

import mysql.connector
from baocaothongke.QLHDB_ui import Ui_Quanlyhodon
