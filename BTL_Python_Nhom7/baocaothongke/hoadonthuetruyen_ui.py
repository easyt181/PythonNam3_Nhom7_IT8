...
################################################################################
## Form generated from reading UI file 'hoadonthuetruyen.ui'
##
...
"border-radius: 10px;")
    ...
    def retranslateUi(self, Quanlyhoadonnhap):
        ...
        self.label.setText(QCoreApplication.translate("Quanlyhoadonnhap", u"H\u00d3A \u0110\u01a0N CHO THU\u00ca", None))
        ...
        ___qtablewidgetitem1.setText(QCoreApplication.translate("Quanlyhoadonnhap", u"Kh\u00e1ch H\u00e0ng", None));
        ___qtablewidgetitem2 = self.tableWidget.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("Quanlyhoadonnhap", u"Nh\u00e2n Vi\u00ean", None));
        ___qtablewidgetitem3 = self.tableWidget.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("Quanlyhoadonnhap", u"Ng\u00e0y Thu\u00ea", None));
        ___qtablewidgetitem4 = self.tableWidget.horizontalHeaderItem(4)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("Quanlyhoadonnhap", u"Ng\u00e0y \u0110\u00ean H\u1ea1n", None));
        ___qtablewidgetitem5 = self.tableWidget.horizontalHeaderItem(5)
        ___qtablewidgetitem5.setText(QCoreApplication.translate("Quanlyhoadonnhap", u"ID Truy\u1ec7n", None));
        ___qtablewidgetitem6 = self.tableWidget.horizontalHeaderItem(6)
        ___qtablewidgetitem6.setText(QCoreApplication.translate("Quanlyhoadonnhap", u"\u0110\u01a1n Gi\u00e1", None));
        ___qtablewidgetitem7 = self.tableWidget.horizontalHeaderItem(7)
        ___qtablewidgetitem7.setText(QCoreApplication.translate("Quanlyhoadonnhap", u"S\u1ed1 L\u01b0\u1ee3ng", None));
        ___qtablewidgetitem8 = self.tableWidget.horizontalHeaderItem(8)
        ___qtablewidgetitem8.setText(QCoreApplication.translate("Quanlyhoadonnhap", u"T\u1ed5ng Ti\u1ec1n", None));
    # retranslateUi
